...
::v-deep .lite-chatbox .cmsg {
	position: relative;
	margin: 4px 4px;
	min-height: 50px;
	border: 0;
}
::v-deep .lite-chatbox .cright {
	text-align: right;
	margin-left: 4px;
}

::v-deep .lite-chatbox .cright .name {
	margin: 0 0px 2px 0;
}
::v-deep .lite-chatbox .cright .content {
	margin: 0 0px 0 0;
...
::v-deep .lite-chatbox .cright .content::after {
	left: -12px;
	top: 8px;
}
::v-deep .lite-chatbox .cleft {
	text-align: left;
	margin-right: 4px;
}

::v-deep .lite-chatbox .cleft .name {
	margin: 0 0 2px 0px;
}
::v-deep .lite-chatbox .cleft .content {
	margin: 0 0 0 0px;
...
::v-deep .lite-chatbox .cleft .content::after {
	left: -12px;
	top: 8px;
}

::v-deep .lite-chatbox img.radius {
	border-radius: 50%;
}
::v-deep .lite-chatbox .name {
	color: #8b8b8b;
	font-size: 14px;
	display: block;
	line-height: 16px;
}
::v-deep .lite-chatbox .name > span {
	vertical-align: middle;
}
::v-deep .lite-chatbox .name .htitle {
...
::v-deep .lite-chatbox .content img {
	width: 100%;
	height: auto;
}
::v-deep .lite-chatbox .content a {
	color: #0072c1;
	margin: 0 5px;
	cursor: hand;
}
::v-deep [litewebchat-theme='dark'] .lite-chatbox .content a {
	color: #00c3ff;
}
</style>
